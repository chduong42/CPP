...
/*   Updated: 2022/08/06 19:13:19 by chduong          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Bureaucrat {
	...
	class GradeTooHighException : public std::exception {
		public:
			virtual void printErr() const throw() {
				std::cerr << "Exception: The highest grade is 1, can't be less" << std::endl;
			}
	};
	...
	class GradeTooLowException : public std::exception {
		public:
			virtual void printErr() const throw() {
				std::cerr << "Exception: The lowest grade is 150, can't be more" << std::endl;
			}
	};
};
