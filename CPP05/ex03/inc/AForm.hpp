...
/*   Updated: 2022/08/06 19:13:16 by chduong          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class AForm {
	...
	class GradeTooHighException : public std::exception {
		public:
			virtual void printErr() const throw() {
				std::cerr << "Exception: One of the grades is too high" << std::endl;
			}
	};
	...
	class GradeTooLowException : public std::exception {
		public:
			virtual void printErr() const throw() {
				std::cerr << "Exception: One of the grades is too low" << std::endl;
			}
	};
	...
	class RequirementException : public std::exception {
		public:
			virtual void printErr() const throw() {
				std::cerr << "Exception: Form is not signed or Bureaucrate is undergraded to execute" << std::endl;
			}
	};
};
